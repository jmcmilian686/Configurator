...
{
    public partial class ConfFile : Form
    {
        public string serverDirectory { get; set; }

        public ConfFile(string dir)
        {
            this.serverDirectory = dir;
            InitializeComponent();
        }
       
        private void ConfFile_Load(object sender, EventArgs e)
        {


            XmlDocument doc = new XmlDocument();
            doc.PreserveWhitespace = true;
            doc.Load(serverDirectory + "\\LabZ_Server.exe.config");
        ...
        private void saveBtn_Click(object sender, EventArgs e)
        {
            ...
            doc.PreserveWhitespace = true;
            doc.Save(serverDirectory + "\\LabZ_Server.exe.config");
